...
### Name
- **Product name:** D'Vantage *(was "Vantage" — renamed this session due to trademark conflicts)*
- **Internal package scope:** `@vantage/*` *(kept — internal detail, not user-facing)*
- **Tagline:** From applied to interview. *(always lowercase except leading F, always terminal period)*
