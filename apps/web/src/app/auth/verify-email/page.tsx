  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        >
          Click the link in the email to verify your address and activate your account. The link
          expires in 24 hours.
        </p>
        {sent && <AuthSuccess message="Verification email resent. Check your inbox." />}
        {error && <AuthError message={error} />}
        {!sent && (
          <AuthButton type="button" variant="ghost" loading={loading} onClick={resend}>
        ...
        >
          Wrong address?{' '}
          <a href="/auth/sign-up" style={{ color: 'var(--vt-brand-400)', textDecoration: 'none' }}>
            Start over
          </a>
        </p>
      </div>
