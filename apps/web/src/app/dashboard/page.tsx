...
export default function DashboardPage() {
    ...
    return (
      ...
      >
        ...
        <Loader2
          size={22}
          strokeWidth={1.5}
          style={{ color: 'var(--vt-text-muted)', animation: 'vt-spin 1s linear infinite' }}
        />
        <span
          style={{
            fontFamily: 'var(--vt-font-body)',
  ...
  if (error !== null || data === null) {
    return (
      ...
      >
        ...
        <span style={{ fontFamily: 'var(--vt-font-body)', fontSize: '13px' }}>
  ...
  const showOptCta =
    latestScore && latestScore.overallScore < 80 && latestScore.scoringStatus === 'complete';
    ...
    <div style={{ maxWidth: 980, margin: '0 auto' }}>
      ...
      >
        <div>
          ...
          >
            ...
            <span style={{ color: 'var(--vt-brand-500)' }}>.</span>
          </h1>
          <p
            style={{
              fontFamily: 'var(--vt-font-body)',
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    gap: 12,
                    padding: '11px 16px',
                    borderBottom: isLast ? 'none' : '1px solid var(--vt-surface-border)',
                    textDecoration: 'none',
      ...
      <div className="vt-stats-grid">
        <StatCard
          icon={Target}
          label="ATS Scores"
          used={data.usage.atsScores.used}
          limit={data.usage.atsScores.limit}
        />
        <StatCard
          icon={Zap}
          label="Optimisations"
          used={data.usage.optimizations.used}
          limit={data.usage.optimizations.limit}
        />
        <StatCard
          icon={Briefcase}
          label="Jobs Created"
          used={data.usage.jobsCreated.used}
          limit={data.usage.jobsCreated.limit}
        />
      </div>
      ...
      {showOptCta && (
        <div
          ...
          style={{
            ...
            padding: '16px 20px',
            background:
              'linear-gradient(135deg, var(--vt-surface-overlay) 0%, var(--vt-surface-raised) 100%)',
