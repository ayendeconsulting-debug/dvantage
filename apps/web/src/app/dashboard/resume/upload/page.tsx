  ...
  return (
    <div style={{ maxWidth: '560px' }}>
      <div style={{ marginBottom: '28px' }}>
        ...
        >
          PDF, DOCX, or plain text · Max 10 MB. D&apos;Vantage extracts and structures your resume
          automatically.
        </p>
      </div>
      ...
      >
        <div
          ...
          tabIndex={0}
          style={{
            border: `1.5px dashed ${dragOver ? 'var(--vt-brand-500)' : 'var(--vt-surface-border)'}`,
            borderRadius: '8px',
            padding: file ? '16px 20px' : '32px 24px',
            cursor: isLoading ? 'default' : 'pointer',
            backgroundColor: dragOver ? '#1a2a3a' : 'transparent',
          ...
          {file ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              <FileText
                size={28}
                strokeWidth={1}
                style={{ color: 'var(--vt-brand-400)', flexShrink: 0 }}
              />
        ...
        <button
          ...
          style={{
            padding: '10px 20px',
            backgroundColor:
              !file || isLoading ? 'var(--vt-surface-border)' : 'var(--vt-brand-500)',
            color: !file || isLoading ? 'var(--vt-text-disabled)' : '#ffffff',
            border: 'none',
            borderRadius: '6px',
            fontFamily: 'var(--vt-font-body)',
            fontSize: '14px',
