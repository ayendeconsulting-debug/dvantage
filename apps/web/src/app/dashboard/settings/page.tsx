          ...
          return (
            <Link
              ...
              style={{
                ...
                gap: '16px',
                padding: '16px',
                border: `1px solid ${isActive ? 'var(--vt-brand-600)' : 'var(--vt-surface-border)'}`,
                borderRadius: '8px',
                backgroundColor: 'var(--vt-surface-raised)',
                textDecoration: 'none',
            ...
            >
              <div
                style={{
                  ...
                  height: '36px',
                  borderRadius: '8px',
                  backgroundColor: isActive ? '#1e3a5f' : 'var(--vt-surface-overlay)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  flexShrink: 0,
              ...
              >
                <item.icon
                  size={16}
                  strokeWidth={1.5}
                  style={{ color: isActive ? 'var(--vt-brand-400)' : 'var(--vt-text-secondary)' }}
                />
              </div>
              <div>
                <div
