    ...
    <div style={{ maxWidth: '560px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '6px' }}>
          ...
          <h1 style={{
            ...
            fontWeight: 700, color: 'var(--vt-text-primary)',
        ...
        <p style={{
          ...
          margin: '0 0 0 48px', lineHeight: 1.5,
        }}>
      ...
      {!loading && fetchErr && (
        <div style={{
          ...
          color: 'var(--vt-status-danger)', fontFamily: 'var(--vt-font-body)', fontSize: '13px',
        }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <Phone size={15} strokeWidth={1.5} style={{ position: 'absolute', left: '11px', top: '50%', transform: 'translateY(-50%)', color: 'var(--vt-text-muted)', pointerEvents: 'none' }} />
              <input
                type="tel"
                value={phone}
            ...
            <p style={{ fontFamily: 'var(--vt-font-body)', fontSize: '12px', color: 'var(--vt-text-muted)', margin: '6px 0 0' }}>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <Link2 size={15} strokeWidth={1.5} style={{ position: 'absolute', left: '11px', top: '50%', transform: 'translateY(-50%)', color: 'var(--vt-text-muted)', pointerEvents: 'none' }} />
              <input
                type="url"
                value={linkedinUrl}
                ...
                className="profile-input"
                style={{ ...inputStyle, borderColor: linkedinError ? 'var(--vt-status-danger)' : undefined }}
              />
            </div>
            {linkedinError && (
              <p style={{ fontFamily: 'var(--vt-font-body)', fontSize: '12px', color: 'var(--vt-status-danger)', margin: '6px 0 0' }}>
                {linkedinError}
              </p>
            )}
          </div>
          ...
          {saveState === 'error' && saveError && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 14px', backgroundColor: '#fef2f2', border: '1px solid #fecaca', borderRadius: '6px', color: 'var(--vt-status-danger)', fontFamily: 'var(--vt-font-body)', fontSize: '13px', marginBottom: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            >
              {saveState === 'saving' && <Loader size={13} strokeWidth={1.5} style={{ animation: 'spin 1s linear infinite' }} />}
              {saveState === 'saving' ? 'Saving…' : 'Save changes'}
            </button>

            {saveState === 'saved' && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontFamily: 'var(--vt-font-body)', fontSize: '13.5px', color: 'var(--vt-status-success)', fontWeight: 500 }}>
                <CheckCircle2 size={15} strokeWidth={1.8} />Saved
              </div>
            )}

            {saveState === 'idle' && isDirty && (
              <span style={{ fontFamily: 'var(--vt-font-body)', fontSize: '12.5px', color: 'var(--vt-text-muted)' }}>
                Unsaved changes
              </span>
            )}
          </div>
      ...
      {/* Footer note */}
      {!loading && !fetchErr && (
        <p style={{ fontFamily: 'var(--vt-font-body)', fontSize: '12.5px', color: 'var(--vt-text-muted)', margin: '16px 0 0', lineHeight: 1.5 }}>
