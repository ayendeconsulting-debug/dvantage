...
export default function SettingsPanel({ onBack }: SettingsPanelProps) {
  ...
  function handleSave(): void {
    ...
    chrome.runtime.sendMessage({ type: 'REQUEST_PROFILE_UPDATE', payload }, (response: unknown) => {
      if (chrome.runtime.lastError) {
          ...
          <>
            ...
            <div style={styles.fieldGroup}>
              ...
              <input
                ...
                autoComplete="url"
              />
              {linkedinErr && <p style={styles.fieldError}>{linkedinErr}</p>}
            </div>
            ...
            {/* Helper note */}
            <p style={styles.helperNote}>These fields are used to autofill application forms.</p>
          </>
        )}
      </div>
